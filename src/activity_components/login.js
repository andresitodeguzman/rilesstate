...
name: 'Login',
    ...
    <div v-if="new_user" class="flex column high wide">
        ...
        <div class="padding-large" style="height: 100%; margin-top: 4rem">
            ...
            <input type=submit class="select-shrink unselect border-radius-large padding wide margin-large-y accent shadow" v-bind:value="signup ? 'Register' : 'Login'" @click.preventdefault="submit()">
