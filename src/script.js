...
Vue.component('ride-panel',{
    ...
    <input type="checkbox" id="map-reveal" style="display: none">
        <div class="flex wide space-between align-center"><span class='padding padding-x-large lnr lnr-chevron-left bold' @click="this.screens.pop()"></span><span class="title">Ride a Train</span><span class="padding padding-x-large"></span></div>
